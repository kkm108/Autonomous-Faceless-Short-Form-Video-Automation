...
SYS_PREAMBLE = (
    ...
    "- IMAGE variety: every IMAGE line must describe a DIFFERENT concrete subject "
    "of its own, tied specifically to that line's own caption idea. Even when the "
    "whole video is about one topic, keep the concrete subject of each slide "
    "distinct — vary the actual thing shown on screen and do not repeat the same "
    "key subject nouns across IMAGE lines.\n\n"
